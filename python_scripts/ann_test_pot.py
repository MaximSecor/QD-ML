...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 27 12:23:12 2021
...
overlap_error_total_pots = np.zeros((total_time,2))
potential_list = []
pot_trials = 5

for k in range(pot_trials):
    ...
    for i in range(1000):
        ...
        prop_rand = generate_propagator(xlist,potential,1000000*np.random.random())
        state = np.matmul(prop_rand,state)
    ...
    overlap_error_total_pots += overlap_error_total

for i in range(total_time):
    print("Time: ",i,"Error: ",overlap_error_total_pots[i]/pot_trials)

print("\nTime:",0," Acc:",overlap_error_total_pots[0]/pot_trials)
print("Time:",9," Acc:",overlap_error_total_pots[9]/pot_trials)
print("Time:",99," Acc:",overlap_error_total_pots[99]/pot_trials)
print("Time:",249," Acc:",overlap_error_total_pots[249]/pot_trials)
print("Time:",499," Acc:",overlap_error_total_pots[499]/pot_trials)
print("Time:",999," Acc:",overlap_error_total_pots[999]/pot_trials)

potential_list = np.array(potential_list)
file_potential = '/Users/maximsecor/Desktop/potential_list.csv'
os.system('touch ' + file_potential)
df_features_potential = pd.DataFrame(potential_list)
